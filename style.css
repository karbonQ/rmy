    ...
    var e = {
        ...
        173: function(e, n) {
            !function(e) {
                ...
                }, I = [1800, 3e3], U = function(e, n) {
                    n = n || {},
                    C(function() {
                        var t, r = P(), i = p("FCP"), o = m("paint", function(e) {
                        ...
                        o && (t = g(e, i, I, n.reportAllChanges),
                        d(function(r) {
                            i = p("FCP"),
                ...
                }, M = [100, 300], j = function(e, r) {
                    r = r || {},
                    C(function() {
                        var o, a = P(), c = p("FID"), u = function(e) {
                ...
                }, $ = [2500, 4e3], G = {}, Y = [800, 1800], Z = function e(n) {
                ...
                e.onCLS = function(e, n) {
                    !function(e, n) {
                        n = n || {},
                        U(T(function() {
                            var t, r = p("CLS", 0), i = 0, o = [], a = function(e) {
                                e.forEach(function(e) {
                                    if (!e.hadRecentInput) {
                                        var n = o[0]
                                          , t = o[o.length - 1];
                            ...
                            c && (t = g(e, r, A, n.reportAllChanges),
                            h(function() {
                                a(c.takeRecords()),
                                t(!0)
                            }),
                    ...
                    !function(e, n) {
                        ...
                        C(function() {
                            ...
                            var r, i = p("INP"), o = function(e) {
                                e.forEach(function(e) {
                                    e.interactionId && X(e),
                                    "first-input" === e.entryType && !W.some(function(n) {
                                        return n.entries.some(function(n) {
                                            return e.duration === n.duration && e.startTime === n.startTime
                                        })
                                    }) && X(e)
                                });
                                var n, t = (n = Math.min(W.length - 1, Math.floor(J() / 50)),
                                W[n]);
                ...
                e.onLCP = function(e, n) {
                    !function(e, n) {
                        n = n || {},
                        C(function() {
                            var t, r = P(), i = p("LCP"), o = function(e) {
                                var n = e[e.length - 1];
                                n && n.startTime < r.firstHiddenTime && (i.value = Math.max(n.startTime - v(), 0),
                                i.entries = [n],
                                t())
        ...
        559: function(e, n) {
            ...
            ,
            n.timingsTargetKeys = ["navigationStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domComplete", "loadEventStart", "loadEventEnd"],
            n.timingsV2TargetKeys = ["nextHopProtocol", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domInteractive", "domComplete", "loadEventStart", "loadEventEnd", "finalResponseHeadersStart", "firstInterimResponseStart", "transferSize", "decodedBodySize"]
        },
        570: function(e, n, t) {
            "use strict";
            ...
            !function() {
                function e(e) {
                    var n = "";
                    if (n = window.location.origin ? window.location.origin : "".concat(window.location.protocol, "://").concat(window.location.host),
                    e && "string" == typeof e)
                        if (0 === e.indexOf("/"))
                            n += e;
                        else
                ...
                !function() {
                    var n, t, s = window.performance || window.webkitPerformance || window.msPerformance || window.mozPerformance, f = "data-cf-beacon", l = document.currentScript || ("function" == typeof document.querySelector ? document.querySelector("script[".concat(f, "]")) : void 0), d = (0,
                        ...
                        if (s && p && p.token) {
                            ...
                            document.addEventListener("visibilitychange", function() {
                                if ("hidden" === document.visibilityState) {
                                    if (L && A()) {
                                        var n = e();
                                        (null == w ? void 0 : w.url) == n && (null == w ? void 0 : w.triggered) || C(),
                                        R(n)
                                    }
                                    !S && w && (S = !0,
                                    I())
                            ...
                            var L = p && (void 0 === p.spa || !0 === p.spa)
                              ...
                              , C = function(t) {
                                var r = function(t) {
                                    var r, o, a = s.timing, c = s.memory, f = t || e(), l = {
                                        memory: {},
                                        timings: {},
                                        resources: [],
                                    ...
                                    if (null == n) {
                                        if ("function" == typeof s.getEntriesByType) {
                                            ...
                                            if (m && Array.isArray(m) && m.length > 0) {
                                                ...
                                                var g = m[0];
                                                (0,
                                                u.buildTimingsObject)(g, l.timingsV2, u.timingsV2TargetKeys)
                                            }
                                        }
                                        if (1 === l.versions.timings) {
                                            var y = a;
                                            l.timings && (0,
                                            u.buildTimingsObject)(y, l.timings, u.timingsTargetKeys)
                                        }
                                        !function(e, n) {
                                            for (var t in e) {
                                                var r = e[t];
                              ...
                              , I = function() {
                                ...
                                p && (0,
                                o.sendObjectBeacon)("", n, function() {}, !0, P)
                            }
                              , U = function() {
                                ...
                                if (r) {
                                    ...
                                    t.pushState = function(o, a, c) {
                                        ...
                                        var u = e()
                                          , s = !0;
                                        return n == u && (s = !1),
                                        s && (A() && ((null == w ? void 0 : w.url) == u && (null == w ? void 0 : w.triggered) || C(u),
                                        R(u)),
                                        i()),
                                        r.apply(t, [o, a, c])
                                    }
                                    ...
                                    window.addEventListener("popstate", function(t) {
                                        A() && ((null == w ? void 0 : w.url) == n && (null == w ? void 0 : w.triggered) || C(n),
                                        R(n)),
                                        n = e(),
                                        i()
                                    })
                    ...
                    function O(e) {
                        ...
                        case "CLS":
                            ...
                            E.cls.currentRect = null === (n = c.largestShiftSource) || void 0 === n ? void 0 : n.currentRect,
                            E.cls.previousRect = null === (t = c.largestShiftSource) || void 0 === t ? void 0 : t.previousRect);
                            break;
                        case "FID":
                    ...
                    function _(e) {
                        if ("function" == typeof s.getEntriesByType) {
                            var n = s.getEntriesByType("navigation")
                              , t = {};
                            e.timingsV2 = {},
                            n && n[0] && (n[0].nextHopProtocol && (t.nextHopProtocol = n[0].nextHopProtocol),
                            n[0].transferSize && (t.transferSize = n[0].transferSize),
                            n[0].decodedBodySize && (t.decodedBodySize = n[0].decodedBodySize),
                            e.dt = n[0].deliveryType),
                            (0,
                            u.buildTimingsObject)(t, e.timingsV2, u.timingsV2TargetKeys)
                        }
                    }
                    function k(e) {
                        var n;
        ...
        976: function(e, n, t) {
            ...
            function f(e, n) {
                return void 0 === n && (n = 0),
                (u[e[n + 0]] + u[e[n + 1]] + u[e[n + 2]] + u[e[n + 3]] + "-" + u[e[n + 4]] + u[e[n + 5]] + "-" + u[e[n + 6]] + u[e[n + 7]] + "-" + u[e[n + 8]] + u[e[n + 9]] + "-" + u[e[n + 10]] + u[e[n + 11]] + u[e[n + 12]] + u[e[n + 13]] + u[e[n + 14]] + u[e[n + 15]]).toLowerCase()
            }
            ...
            var y = function(e, n, t) {
                ...
                if (e)
                    c = g(null !== (a = null !== (i = e.random) && void 0 !== i ? i : null === (o = e.rng) || void 0 === o ? void 0 : o.call(e)) && void 0 !== a ? a : p(), e.msecs, e.nsecs, e.clockseq, e.node, n, t);
                else {
                    var l = Date.now()
                      , d = p();
                    !function(e, n, t) {
                        ...
                        e.nsecs = 0)) : n > e.msecs ? e.nsecs = 0 : n < e.msecs && (e.node = void 0),
                        e.node || (e.node = t.slice(10, 16),
                        e.node[0] |= 1,
                        e.clockseq = 16383 & (t[8] << 8 | t[9])),
                        e.msecs = n
                    }(m, l, d),
                    c = g(d, m.msecs, m.nsecs, u ? void 0 : m.clockseq, u ? void 0 : m.node, n, t)
                }
                return null != n ? n : f(c)
            };
            function h(e) {
            ...
            var C = function(e) {
                var n = function(e) {
                    ...
                    for (var n = new Uint32Array(T(8 * e.length)).fill(0), t = 0; t < e.length; t++)
                        n[t >> 2] |= (255 & e[t]) << t % 4 * 8;
                    return n
                }(e)
                  , t = function(e, n) {
                ...
                return function(e) {
                    for (var n = new Uint8Array(4 * e.length), t = 0; t < 4 * e.length; t++)
                        n[t] = e[t >> 2] >>> t % 4 * 8 & 255;
                    return n
                }(t)
            }
                ...
                return !B.randomUUID || n || e ? function(e, n, t) {
                    ...
                    n) {
                        if ((t = t || 0) < 0 || t + 16 > n.length)
                            throw new RangeError("UUID byte range ".concat(t, ":").concat(t + 15, " is out of buffer bounds"));
                        for (var c = 0; c < 16; ++c)
                            n[t + c] = a[c];
                        return n
                    }
            ...
            var M = function(e) {
                ...
                for (var i = (e = r).length / 4 + 2, o = Math.ceil(i / 16), a = new Array(o), c = 0; c < o; ++c) {
                    for (var u = new Uint32Array(16), s = 0; s < 16; ++s)
                        u[s] = e[64 * c + 4 * s] << 24 | e[64 * c + 4 * s + 1] << 16 | e[64 * c + 4 * s + 2] << 8 | e[64 * c + 4 * s + 3];
                    a[c] = u
                }
            ...
            function N(e) {
                var n, t = (n = "string" == typeof e ? c(e) : e,
            ...
            function H(e, n, t, r, i) {
                ...
                null != t || (t = 127 * e[6] << 24 | e[7] << 16 | e[8] << 8 | e[9]),
            ...
            var z = function(e, n, t) {
                var r, i, o, a;
                if (e)
                    a = H(null !== (o = null !== (r = e.random) && void 0 !== r ? r : null === (i = e.rng) || void 0 === i ? void 0 : i.call(e)) && void 0 !== o ? o : p(), e.msecs, e.seq, n, t);
                else {
                    var c = Date.now()
                      , u = p();
                    !function(e, n, t) {
                        ...
                        n > e.msecs ? (e.seq = t[6] << 23 | t[7] << 16 | t[8] << 8 | t[9],
                        e.msecs = n) : (e.seq = e.seq + 1 | 0,
                        0 === e.seq && e.msecs++)
                    }(V, c, u),
